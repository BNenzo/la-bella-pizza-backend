package ar.edu.ubp.das.la_bella_pizza_backend.components;
...
public class SimpleJdbcCallFactory {
  ...
  public <T> Map<String, Object> executeQueryWithOutputs(String procedureName, String schemaName,
      SqlParameterSource params, String resultSetName, Class<T> mappedClass) {
  ...
  public <T> List<T> executeQuery(String procedureName, String schemaName, SqlParameterSource params,
      String resultSetName, Class<T> mappedClass) {
  ...
  public <T> Map<String, Object> executeWithOutputs(String procedureName, String schemaName,
